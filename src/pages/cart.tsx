    ...
    <div className="h-full bg-[#f5f5f5] flex">
      ...
      <div className="w-full ">
        <div className=" flex bg-white pl-10 pt-2 rounded-lg">
          ...
          <div
            className="flex-1 text-center p-4 text-2xl bg-white  text-[#ee4d2d]"
            onClick={() => {
              setVisible(true);
            }}
          >
      ...
      <PortalDraw visible={visible} handleSetVisible={setVisible} >
        <div className="h-full flex-1 bg-[#f5f5f5] px-4 border p-2 rounded-lg  w-1/3 overflow-auto">
          {/* overflow-scroll fixed top-0 right-0 */}
